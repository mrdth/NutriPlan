                    ...
                    <div v-if="selectedRecipe" class="rounded-md border p-3 dark:border-gray-700">
                        ...
                        <div class="mt-3 space-y-2">
                            <div>
                                ...
                                <Input id="scale-factor" v-model.number="scaleFactor" type="number" min="0.1" max="10" step="0.1" />
            ...
            <DialogContent class="sm:max-w-md">
                ...
                <div class="space-y-4 py-4">
                    <div>
                        ...
                        <Input id="edit-scale-factor" v-model.number="editScaleFactor" type="number" min="0.1" max="10" step="0.1" />
                        <p class="mt-1 text-xs text-gray-500">
