    ...
    <div class="space-y-6">
      ...
      <div>
        ...
        <div class="mt-1 flex flex-wrap gap-2">
          <Badge v-for="category in categories" :key="category.id" variant="outline" class="cursor-pointer" :class="{
        ...
        <div class="mt-4 space-y-4">
          <div v-for="(ingredient, index) in form.ingredients" :key="index" class="flex items-end gap-4">
            ...
            <div class="w-24">
              ...
              <Input :id="'amount-' + index" v-model.number="ingredient.amount" type="number" min="0" step="0.01" class="mt-1" required />
