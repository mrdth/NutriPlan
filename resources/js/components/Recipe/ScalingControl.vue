    ...
    <div class="flex items-center space-x-2">
      ...
      <div class="relative flex items-center">
        <input
          ...
          type="number"
          min="1"
          class="h-8 w-16 rounded-md border border-gray-300 px-3 py-1 text-center text-sm shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200"
